            ...
            if (key.equals("JNU") || key.equals("AMU")) {
                ...
                for (Student student : studentArrayList) {
                    if (student.getAge() <= 25 && student.getCity().equals("PUNe")) {
                        System.out.println(" UNIVERSITY WISE " + key + " Name " + student.getName() + " AGe " + student.getAge() + " CITY " + student.getCity() + " Section " + student.getSection());
            ...
            if (key.equals("JNU") || key.equals("AMU")) {
                for (Student student : studentArrayList) {
                    if (highestAgeStudent < student.getAge()) {
                        ...
                        System.out.println(" NAme " + student.getName() + " Age " + student.getAge() + " City " + student.getCity() + " Section " + student.getSection());
        ...
        for (Student student1 : u1Student) {
            for (Student student2 : u2Student) {
                if (student1.getCity().equals(student2.getCity())) {
                    System.out.println("UNIVERSITY 1 : Name " + student1.getName() + " Age " + student1.getAge() + " CIty " + student1.getCity() + " SECTION " + student1.getSection());
                    System.out.println("UNIVERSITY 2 : NAme " + student2.getName() + " Age " + student2.getAge() + " City " + student2.getCity() + " Section " + student2.getSection());
                }
            }
        }
    }
        ...
        for (Student student1 : jnuStudent) {
            for (Student student2 : amuStudent) {
                if (student1.getAge() == student2.getAge()) {
                    ...
                    System.out.println("JNU UNIVERSITY : NAme " + student1.getName() + " Age " + student1.getAge() + " City " + student1.getCity() + " Section " + student1.getSection());
                    System.out.println("AMU UNIVERSITY : Name " + student2.getName() + " Age " + student2.getAge() + " City " + student2.getCity() + " Section " + student2.getSection());
                }
            }
        }
    }
